...
define amdgpu_cs_chain void @chain_to_chain(<3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY7]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY8]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA2]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY7]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY8]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ...
  ; DAGISEL-GFX10-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX10-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX10-NEXT:   $sgpr2 = COPY [[V_READA2]]
...
define amdgpu_cs_chain void @indirect(ptr inreg %callee, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY10]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY11:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; DAGISEL-GFX11-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[COPY11]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY12]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX11-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY13]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY14]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA4]]
  ; DAGISEL-GFX11-NEXT:   $vgpr8 = COPY [[COPY3]]
  ; DAGISEL-GFX11-NEXT:   $vgpr9 = COPY [[COPY2]]
  ; DAGISEL-GFX11-NEXT:   $vgpr10 = COPY [[COPY1]]
  ; DAGISEL-GFX11-NEXT:   $vgpr11 = COPY [[COPY]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY10]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY11:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; DAGISEL-GFX10-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[COPY11]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY12]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX10-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY13]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY14]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ...
  ; DAGISEL-GFX10-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX10-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX10-NEXT:   $sgpr2 = COPY [[V_READA4]]
  ; DAGISEL-GFX10-NEXT:   $vgpr8 = COPY [[COPY3]]
  ; DAGISEL-GFX10-NEXT:   $vgpr9 = COPY [[COPY2]]
  ; DAGISEL-GFX10-NEXT:   $vgpr10 = COPY [[COPY1]]
  ; DAGISEL-GFX10-NEXT:   $vgpr11 = COPY [[COPY]]
...
define amdgpu_cs_chain void @nonuniform_callee(ptr %callee, i32 inreg %sgpr, i32 %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY6]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY6]], implicit $exec
...
define amdgpu_cs_chain void @non_imm_exec(i64 inreg %exec, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY10]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY11]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA2]]
  ; DAGISEL-GFX11-NEXT:   $vgpr8 = COPY [[COPY3]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY10]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY11]], implicit $exec
...
define amdgpu_cs_chain void @indirect_with_non_imm_exec(ptr inreg %callee, i64 inreg %exec, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[COPY11]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY12]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE1]].sub0
  ; DAGISEL-GFX11-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY13]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY14]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX11-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY16]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY17]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA4]]
  ; DAGISEL-GFX11-NEXT:   $vgpr8 = COPY [[COPY3]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[COPY11]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY12]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE1]].sub0
  ; DAGISEL-GFX10-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY13]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY14]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX10-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY16]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY17]], implicit $exec
