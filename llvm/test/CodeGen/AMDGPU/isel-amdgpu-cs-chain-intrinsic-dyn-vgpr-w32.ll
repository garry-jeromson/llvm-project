...
define amdgpu_cs_chain void @direct_callee_direct_fallback(<3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX12-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY7]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY8]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX12-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX12-NEXT:   $sgpr2 = COPY [[V_READA2]]
...
define amdgpu_cs_chain void @indirect_callee_direct_fallback(i32 inreg %exec, ptr inreg %callee, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr, i32 inreg %num_vgpr) {
  ...
  ; DAGISEL-GFX12-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY12]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; DAGISEL-GFX12-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY13]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY14]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX12-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32 = S_MOV_B32 target-flags(amdgpu-abs32-hi) @retry_vgpr_alloc
  ; DAGISEL-GFX12-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 target-flags(amdgpu-abs32-lo) @retry_vgpr_alloc
  ...
  ; DAGISEL-GFX12-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY16]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY17]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX12-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX12-NEXT:   $sgpr2 = COPY [[V_READA4]]
...
define amdgpu_cs_chain void @direct_callee_indirect_fallback(i32 inreg %exec, ptr inreg %retry, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr, i32 inreg %num_vgpr) {
  ...
  ; DAGISEL-GFX12-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY11]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY12]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY13]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX12-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX12-NEXT:   $sgpr2 = COPY [[V_READA2]]
  ; DAGISEL-GFX12-NEXT:   $vgpr8 = COPY [[COPY4]]
...
define amdgpu_cs_chain void @indirect_callee_indirect_fallback(i32 inreg %exec, i32 inreg %retry_exec, ptr inreg %callee, ptr inreg %retry, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr, i32 inreg %num_vgpr) {
  ...
  ; DAGISEL-GFX12-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY15]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY16:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE1]].sub0
  ; DAGISEL-GFX12-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[COPY16]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY17]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX12-NEXT:   [[COPY18:%[0-9]+]]:vgpr_32 = COPY [[COPY7]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY18]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY19:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY19]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   [[COPY20:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX12-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY20]], implicit $exec
  ; DAGISEL-GFX12-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX12-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX12-NEXT:   $sgpr2 = COPY [[V_READA4]]
  ; DAGISEL-GFX12-NEXT:   $vgpr8 = COPY [[COPY4]]
