...
define amdgpu_cs_chain void @non_imm_exec(i32 inreg %exec, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY8]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY10]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA1]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA2]]
  ; DAGISEL-GFX11-NEXT:   $vgpr8 = COPY [[COPY3]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY8]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY9]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY10]], implicit $exec
...
define amdgpu_cs_chain void @indirect_with_non_imm_exec(ptr inreg %callee, i32 inreg %exec, <3 x i32> inreg %sgpr, { i32, ptr addrspace(5), i32, i32 } %vgpr) {
  ...
  ; DAGISEL-GFX11-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY11]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; DAGISEL-GFX11-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[COPY12]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY13]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX11-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY14]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX11-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY16]], implicit $exec
  ; DAGISEL-GFX11-NEXT:   $sgpr0 = COPY [[V_READA2]]
  ; DAGISEL-GFX11-NEXT:   $sgpr1 = COPY [[V_READA3]]
  ; DAGISEL-GFX11-NEXT:   $sgpr2 = COPY [[V_READA4]]
  ; DAGISEL-GFX11-NEXT:   $vgpr8 = COPY [[COPY3]]
  ...
  ; DAGISEL-GFX10-NEXT:   [[V_READA:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY11]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; DAGISEL-GFX10-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[COPY12]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA1:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO killed [[COPY13]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_64 = REG_SEQUENCE killed [[V_READA1]], %subreg.sub0, killed [[V_READA]], %subreg.sub1
  ; DAGISEL-GFX10-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[COPY6]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA2:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY14]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[COPY5]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA3:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY15]], implicit $exec
  ; DAGISEL-GFX10-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[COPY4]]
  ; DAGISEL-GFX10-NEXT:   [[V_READA4:%[0-9]+]]:sreg_32_xm0 = V_READANYLANE_B32_PSEUDO [[COPY16]], implicit $exec
